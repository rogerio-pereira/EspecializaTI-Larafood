                ...
                <tbody>
                    @foreach ($details as $detail)
                        <tr>
                            <td>{{$detail->name}}</td>
                            <td>
                                <a href='{{route('admin.plan.details.edit', [$plan->url, $detail->id])}}' class='btn btn-info'>Edit</a>
                                <a href='{{route('admin.plan.details.show', [$plan->url, $detail->id])}}' class='btn btn-warning'>Ver</a>
                            </td>
                        </tr>        
                    @endforeach
                </tbody>

...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class='breadcrumb-item active'><a href='{{route('admin.plan.details.edit', [$plan->url, $detail->id])}}'>Editar</a></li>
    </ol>
...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.plan.details.update', [$plan->url, $detail->id])}}" method='POST'>
                @method('PUT')
